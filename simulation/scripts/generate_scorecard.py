...
def _classify_batch(batch: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    from prompts.scorecard import COMMENT_CLASSIFICATION
    prompt = COMMENT_CLASSIFICATION.format(comment_block=comment_block)
...
def _classify_interview_batch(
    ...
    from prompts.scorecard import INTERVIEW_CLARITY
    prompt = INTERVIEW_CLARITY.format(post_summary=post_summary, response_block=response_block)
